...
class About extends React.Component{
    render() {
        return (
            <div>
                <section class="container-lg bg-blue-400 my-10 shadow-2xl">
                    <h2 class="text-5xl text-white p-4 border-solid border-4 border-slate-500 font-bold mx-1 shadow-2xl">About Me</h2>
